package com.zhisangui.zojbackendquestionservice.controller;

import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.zhisangui.zojbackendcommon.annotation.AuthCheck;
import com.zhisangui.zojbackendcommon.common.BaseResponse;
import com.zhisangui.zojbackendcommon.common.DeleteRequest;
import com.zhisangui.zojbackendcommon.common.ErrorCode;
import com.zhisangui.zojbackendcommon.common.ResultUtils;
...
import zojbackendmodel.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User user = userFeignClient.getLoginUser(request);
        if (!userId.equals(user.getId()) && !userFeignClient.isAdmin(user)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
     ...
     * @param request
     * @return resultNum 本次提交是否成功
     */
    @PostMapping("/question_submit")
    public BaseResponse<Boolean> doSubmit(@RequestBody QuestionSubmitAddRequest questionSubmitAddRequest,
                                          HttpServletRequest request) {
        ...
        boolean res = questionSubmitService.doQuestionSubmit(questionSubmitAddRequest, loginUser);
